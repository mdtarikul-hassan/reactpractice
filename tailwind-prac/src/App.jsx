    ...
    {/* 3 --------------------------- spacing --------------------- */}
      ...
      {/* 9 ----------------------------- effects ----------------------  */}
        ...
        {/* 10 ----------------------------- filter ------------------------- */}
          ...
          {/* 10.12 --------- backdrop contrast ------ */}
          <h1>backdrop contrast</h1>
          <div className="flex items-center justify-center bg-gray-100">
            <img src="https://picsum.photos/500/300" className="backdrop-contrast-50 rounded-lg"/>
            <img src="https://picsum.photos/500/300" className="backdrop-contrast-100 rounded-lg"/>
            <img src="https://picsum.photos/500/300" className="backdrop-contrast-150 rounded-lg"/>
          ...
          {/* 10.14 ---------backdrop hue rotate ------ */}
          <h1>backdrop hue-rotate</h1>
          <div className="flex items-center justify-center bg-gray-100">
            <img src="https://picsum.photos/500/300" className="backdrop-hue-rotate-15 rounded-lg"/>
            <img src="https://picsum.photos/500/300" className="backdrop-hue-rotate-100 rounded-lg"/>
            <img src="https://picsum.photos/500/300" className="backdrop-hue-rotate-200 rounded-lg"/>
            <img src="https://picsum.photos/500/300" className="backdrop-hue-rotate-300 rounded-lg"/>
          </div>

          {/* 10.15 --------- backdrop invert ------ */}
          <h1>backdrop invert</h1>
          <div className="flex items-center justify-center bg-gray-100">
            <img src="https://picsum.photos/500/300" className="backdrop-invert-0 rounded-lg"/>
            <img src="https://picsum.photos/500/300" className="backdrop-invert-20 rounded-lg"/>
        ...
        {/* 11 ----------------------------- table ------------------------------- */}
          {/* 11.1 ------ border collapse ------------ */}
          <div>
            <h1>Border collapse</h1>
            <table class="border-collapse border border-gray-400 bg-cyan-900 text-gray-300">
              <thead>
                <tr>
          ...
          <div>
            <h1>table layout</h1>
            <table class="table-auto border border-gray-400 bg-cyan-900 text-gray-300">
              <thead>
                <tr>
                  <th class="border border-gray-300 bg-cyan-900 text-gray-300">State</th>
                  <th class="border border-gray-300 bg-cyan-900 text-gray-300">City</th>
          ...
          <div>
            <h1>caption top</h1>
            <table class=" border border-gray-400 bg-cyan-900 text-gray-300">
              <caption class="caption-top text-amber-950">
        ...
        {/* 12 ---------------------------------- transition and animation --------------------------- */}
          ...
          <div>
            ...
            <button class="bg-blue-500 transition delay-150 duration-300 ease hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 text-white rounded-sm">eade 1</button>
            <button class="bg-blue-500 transition delay-150 duration-300 ease-in hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 text-white rounded-sm">ease in 2</button>
